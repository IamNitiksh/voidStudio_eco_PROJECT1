    ...
    onAuthStateChanged(auth, async (user) => {
      if (user) {
        try {
          ...
          // User may not exist in DB yet (e.g., first sign-in before newUser is called)
          // Silently treat as not existing and let the user flow handle it
          console.warn("User not found in DB yet, treating as not logged in");
          dispatch(userNotExist());
        }
